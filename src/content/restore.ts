...
function findByLabelText(field: CapturedField): HTMLElement | null {
  if (!field.labelText) return null;
...
function firstFound(...elements: Array<Element | null | undefined>): HTMLElement | null {
...
function findTarget(field: CapturedField): HTMLElement | null {
...
function applyFieldValue(target: HTMLElement, field: CapturedField): boolean {
...
async function waitForDomStability(timeoutMs = 3000): Promise<void> {
...
export async function restorePageSnapshot(snapshot: PageSnapshot): Promise<RestoreReport> {
